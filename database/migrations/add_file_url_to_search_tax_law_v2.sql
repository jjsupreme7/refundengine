-- ============================================================================
-- Add file_url to search_tax_law RPC function (Fixed Version)
-- This migration drops and recreates the search_tax_law function to include
-- the file_url field from the knowledge_documents table
-- ============================================================================

-- Drop the existing function first
DROP FUNCTION IF EXISTS search_tax_law(vector, float, int, text, text[], text[]);

-- Recreate with file_url included
