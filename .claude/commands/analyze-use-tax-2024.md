# Analyze Use Tax 2024

## Before Starting
Invoke the `/analyze-invoices` skill to load the full analysis methodology.

Analyze invoices from the Use Tax 2024 workbook using Claude Code (direct analysis, no external APIs).

## Source & Output
- **Source:** `~/Desktop/Files/Files to be Analyzed/Use Tax Phase 3 2024 Oct 17.xlsx`
- **Output:** `~/Desktop/Files/Analyzed_Output/Phase_3_2024_Use Tax - Analyzed.xlsx`
