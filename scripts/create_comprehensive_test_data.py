...
ADDITIONAL_INFO = [
    "Advertising", "Building Permits", "City Permit", "Cleaning", "Construction",
    "Credit Card Processing Fee", "Data Processing", "Decommissioning", "Dining",
    "Discount Codes", "Disposal", "Food", "Freight", "Gift Certificates",
    "Help Desk", "Hosting", "Inspection", "Installation", "Internet Access",
    "Janitorial", "Landscape", "Membership Dues", "Moving Permit", "Postage",
    "Professional", "Public Relations", "Recycling", "Repaired", "Repair",
    "Sign Installation", "Software Development/Configuration", "Storage",
    "Telecommunications", "Testing", "IT Reimbursement", "Warehousing",
...
REFUND_BASIS = [
    ...
    "Out-of-State/Partial Out-of-State", "Out-of-State Services",
    "Out-of-State Shipment", "Wrong Rate", "Partial Out-of-State Shipments",
    "Resale"
]
...
def create_master_excel():
    ...
    for po in df['Purchase_Order_Number'].unique():
        ...
        print(f"   {po}: {len(po_data)} rows, {po_data['Invoice_Number'].nunique()} invoices, Vendor: {po_data.iloc[0]['Vendor_Name']}")
