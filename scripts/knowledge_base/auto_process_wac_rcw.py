...
def check_downloads_complete():
    ...
    rcw_04_complete = (
        rcw_82_04_dir.exists() and len(list(rcw_82_04_dir.glob("*.html"))) >= 687
    )
    rcw_08_complete = (
        rcw_82_08_dir.exists() and len(list(rcw_82_08_dir.glob("*.html"))) >= 177
    )
    rcw_12_complete = (
        rcw_82_12_dir.exists() and len(list(rcw_82_12_dir.glob("*.html"))) >= 147
    )
    rcw_14_complete = (
        rcw_82_14_dir.exists() and len(list(rcw_82_14_dir.glob("*.html"))) >= 184
    )
    rcw_32_complete = (
        rcw_82_32_dir.exists() and len(list(rcw_82_32_dir.glob("*.html"))) >= 357
    )
