...
class SmartCache:
    ...
    def get_invoice_data(self, file_path: str) -> Optional[Dict]:
        ...
        if datetime.now() > expires_at:
            ...
            self.invoice_cache_db.execute(
                "DELETE FROM invoice_cache WHERE file_hash = ?",
                (file_hash,)
            )
    ...
    def get_rag_results(self, category: str, state_code: str = 'WA') -> Optional[List[Dict]]:
        """
    ...
    def set_rag_results(self, category: str, results: List[Dict], state_code: str = 'WA', ttl_days: int = 7):
        """
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        return {
            "vendor_database": {
                "total_vendors": len(self.vendor_db)
            },
            "invoice_cache": {
