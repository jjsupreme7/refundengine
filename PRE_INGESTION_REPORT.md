...
1. **[docs/AGENTIC_RAG_GUIDE.md](docs/AGENTIC_RAG_GUIDE.md)** - Complete guide to agentic RAG
2. **[test_agentic_rag.py](test_agentic_rag.py)** - Test suite with 5 test cases
3. **[PRE_INGESTION_REPORT.md](PRE_INGESTION_REPORT.md)** - This document
